class Armor < ActiveRecord::Base
  ...
  validates_presence_of :name, :price, :armor_bonus, :max_dex_bonus, :check_penalty, :spell_failure,
                        :weight, :armor_type_id, :armor_type, :equipment_slot_id, :equipment_type_id
