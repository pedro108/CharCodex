...
function Grid(list, tilesize, layers) {
  ...
  $(this.layers).each(function(index, value) {
	...
	this.terrains.push(new BackgroundGridItem(this, 0, 'bg', null, 2));
	this.objects.push(new BackgroundGridItem(this, 0, 'obj', null, 2));
	this.monsters.push(new GridItem(this, 0, 'mst', null));
